...
main_led_blink.obj: ../main_led_blink.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C6000 Compiler'
	"D:/ti/ccsv7/tools/compiler/ti-cgt-c6000_8.2.1/bin/cl6x" -mv6740 --include_path="D:/Users/zhuji/Projects/CCD/SY18-201708/DSP/gpioTest" --include_path="D:/ti/ccsv7/tools/compiler/ti-cgt-c6000_8.2.1/include" --define=SOC_OMAPL138 --define=lcdkOMAPL138 --define=c6748 -g --diag_warning=225 --diag_wrap=off --display_error_number --preproc_with_compile --preproc_dependency="main_led_blink.d" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
